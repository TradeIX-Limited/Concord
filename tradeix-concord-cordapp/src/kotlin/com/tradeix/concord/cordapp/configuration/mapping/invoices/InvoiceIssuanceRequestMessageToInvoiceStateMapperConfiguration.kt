...
class InvoiceIssuanceRequestMessageToInvoiceStateMapperConfiguration
    : MapperConfiguration<InvoiceIssuanceRequestMessage, InvoiceState>() {

    override fun map(source: InvoiceIssuanceRequestMessage, serviceHub: ServiceHub): InvoiceState {
