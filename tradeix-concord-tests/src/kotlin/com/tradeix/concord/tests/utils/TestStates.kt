...
import com.tradeix.concord.tests.utils.TestInstants.INSTANT_FUTURE_2
import com.tradeix.concord.tests.utils.TestInstants.INSTANT_FUTURE_3
...
object TestStates {
    ...
    val INVOICE_STATE = InvoiceState(
            ...
            created = INSTANT_FUTURE_2,
            updated = INSTANT_FUTURE_2,
            expectedSettlementDate = INSTANT_FUTURE_3,
            settlementDate = null,
            mandatoryReconciliationDate = null,
            invoiceDate = INSTANT_PAST_2,
            status = "STATUS",
    ...
    val PROMISSORY_NOTE_STATE = PromissoryNoteState(
            ...
            dateOfIssue = INSTANT_PAST_1,
            dateOfMaturity = INSTANT_FUTURE_1
    )
}