...
class FundingResponseIssuanceInitiatorFlow(
    ...
    override fun call(): SignedTransaction {
        ...
        logger.debug("*** FUNDING RESPONSE ISSUANCE >> Funding Response external Id: " + fundingResponseState.linearId.externalId)
        fundingResponseState.invoiceLinearIds.forEach {
            logger.debug("*** FUNDING RESPONSE ISSUANCE >> Invoice external Id: " + it.externalId)
        }
