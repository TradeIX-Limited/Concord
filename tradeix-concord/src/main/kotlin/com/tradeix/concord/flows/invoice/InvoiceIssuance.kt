...
object InvoiceIssuance {
    @InitiatingFlow
    @StartableByRPC
    class InitiatorFlow(private val model: InvoiceIssuanceFlowModel) : FlowLogic<SignedTransaction>() {
        companion object {
        ...
        override fun call(): SignedTransaction {
            val validator = InvoiceIssuanceFlowModelValidator(model)
            ...
            val outputState = InvoiceState(
                    linearId = UniqueIdentifier(model.externalId!!),
                    owner = supplier,
                    buyer = buyer,
                    supplier = supplier,
                    funder = funder,
                    ...
                    status = model.status!!,
                    rejectionReason = model.rejectionReason ?: "" /*TODO : HACK!*/,
