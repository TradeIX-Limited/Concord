...
import com.tradeix.concord.shared.domain.schemas.PurchaseOrderSchemaV1.PersistentPurchaseOrderSchemaV1
import com.tradeix.concord.shared.domain.states.PurchaseOrderState
import com.tradeix.concord.shared.mapper.Mapper

class PurchaseOrderSchemaV1Mapper
    : Mapper<PurchaseOrderState, PersistentPurchaseOrderSchemaV1>() {

    override fun map(source: PurchaseOrderState): PersistentPurchaseOrderSchemaV1 {
        return PersistentPurchaseOrderSchemaV1(
