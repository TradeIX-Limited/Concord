...
class FundingResponseAcceptanceFlow(
    ...
    override fun call(): SignedTransaction {
        ...
        logger.debug("*** FUNDING RESPONSE ACCEPTANCE >> Funding Response external Id: " + fundingResponseOutputState.linearId.externalId)
        fundingResponseOutputState.invoiceLinearIds.forEach {
            logger.debug("*** FUNDING RESPONSE ACCEPTANCE >> Invoice external Id: " + it.externalId)
        }
